...
export declare namespace Agro {
  ...
  export type ProductStructOutput = [
    ...
    owner: string,
    stock: bigint
  ] & { price: bigint; owner: string; stock: bigint };
}
...
export interface AgroInterface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "isFarmer", data: BytesLike): Result;
...
export interface Agro extends BaseContract {
  ...
  isFarmer: TypedContractMethod<[user: AddressLike], [boolean], "view">;

  products: TypedContractMethod<
    [arg0: BigNumberish],
    [
      [bigint, string, bigint] & { price: bigint; owner: string; stock: bigint }
    ],
    "view"
  >;
